...
const handler = createMcpHandler(async (server) => {
  ...
  /**
   * Tool & Resource related to show_apps_sdk_dashboard
   */
  ...
  // END Tool & Resource related to show_apps_sdk_dashboard
  // ------------------------------------------------------------

  /**
   * Tool & Resource related to read_only_widget
   */
  ...
  // END Tool & Resource related to read_only_widget
  // ------------------------------------------------------------
